...
import { removePlayer } from "./Helpers";
const KEY = process.env.REACT_APP_NBA_API_KEY;
var roster = [];

class SelectTheirTeam extends Component {
  constructor(props) {
    super(props);
  ...
  displayPlayer = (e) => {
    ...
    let table = document.getElementById("roster2");
    // player entry
  ...
  render() {
    return (
      <div>
        ...
        <br></br>
        <select id="team2" onChange={this.displayPlayer}>
...
export default SelectTheirTeam;
